...
sort_criteria = ['-date','type']   # Ordered by year, then type.



titlestring = 'CBI Publications'
""" bibliography title """
...
stylesheet_url = "site/style_c.css"
